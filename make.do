...
make gigs, replace toc pkg version(0.5.0)                                    ///
     ...
     install("_gclassify_sfga.ado;_gclassify_stunting.ado;_gclassify_svn.ado;_gclassify_wasting.ado;_gclassify_wfa.ado;_gclassify_headsize.ado;_gig_fet.ado;_gig_nbs.ado;_gig_png.ado;_gwho_gs.ado;gigs_classify_growth.ado;gigs_zscore.ado;gigs_zscoring_lgls.ado;gigs_categorise.ado;gigs_ipolate_coeffs.mo;classify_sga.sthlp;classify_stunting.sthlp;classify_svn.sthlp;classify_wasting.sthlp;classify_wfa.sthlp;classify_headsize.sthlp;gigs_classify_growth.sthlp;gigs.sthlp;ig_fet.sthlp;ig_nbs.sthlp;ig_nbsGAMLSS_hcfga.dta;ig_nbsGAMLSS_lfga.dta;ig_nbsGAMLSS_wfga.dta;ig_png.sthlp;who_gs.sthlp;whoLMS_acfa.dta;whoLMS_bfa.dta;whoLMS_hcfa.dta;whoLMS_lhfa.dta;whoLMS_ssfa.dta;whoLMS_tsfa.dta;whoLMS_wfa.dta;whoLMS_wfh.dta;whoLMS_wfl.dta") ///
