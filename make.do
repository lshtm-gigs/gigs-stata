...
make gigs, replace toc pkg version(0.3.0)                                    ///
     ...
     install("_gclassify_sga.ado;_gclassify_stunting.ado;_gclassify_svn.ado;_gclassify_wasting.ado;_gclassify_wfa.ado;_gig_nbs.ado;_gig_png.ado;_gwho_gs.ado;interpolate_coeffs.ado;classify_sga.sthlp;classify_stunting.sthlp;classify_svn.sthlp;classify_wasting.sthlp;classify_wfa.sthlp;gigs.sthlp;ig_nbs.sthlp;ig_nbsGAMLSS_hcfga.dta;ig_nbsGAMLSS_lfga.dta;ig_nbsGAMLSS_wfga.dta;ig_png.sthlp;who_gs.sthlp;whoLMS_acfa.dta;whoLMS_bfa.dta;whoLMS_hcfa.dta;whoLMS_lhfa.dta;whoLMS_ssfa.dta;whoLMS_tsfa.dta;whoLMS_wfa.dta;whoLMS_wfh.dta;whoLMS_wfl.dta") ///
