...
program GrowthSex_Badsyntax
	di as err "Error in {bf:gigs_classify_growth}: the {bf:sexcode()} " /*
		*/ "option is invalid. See {help gigs_classify_growth} for more " /*
		*/ "information."
	exit 198
end
...
program Badsexvar_growth
	di as err "Error in {bf:gigs_classify_growth}: the {bf:sex()} option " /*
		*/ "should be an unlabelled byte, int or str variable. See " /*
		*/ "{help gigs_classify_growth} for more information."
	exit 109
end

capture prog drop Badidvar_growth
program Badidvar_growth
	di as err "Error in {bf:gigs_classify_growth}: the {bf:id()} option " /*
		*/ "should be a byte, int or str variable. See " /*
		*/ "{help gigs_classify_growth} for more information."
	exit 109
end
...
program BadExistingVar_growth
	args var
	di as error "Error in {bf:gigs_classify_growth}: Variable {bf:`var'} is " /* 
	    */ "generated by {bf:gigs_classify_growth} but already exists. " /* 
	    */ "Either specify the {bf:replace} option or rename the existing " /* 
	    */ "variable."
	exit 110
end
